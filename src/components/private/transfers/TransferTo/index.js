    ...
    <main className="main-pago main-user__dash">
      <section className="main-pago__section">
        ...
        <h1 className="main-pago__section__title">
          <Link to="/transfers" className="back-title"><span className="fas fa-arrow-left mr-3"></span></Link> Envía dinero a terceros
        </h1>
        <p className="main-pago__section__subtitle">Colocar el nombre de usuario del destinatario y selecciona de que cuenta quieres enviar tu dinero.</p>
        <TransferForm />
      </section>
    </main>
  )
