...
import { getUserInfoByPayId } from '../../../../../actions/auth';
    ...
    <div className="form-confirmation">
    {
      ...
      <>
        ...
        <div className="form-details">
          ...
          <span className="form-detail-right">{(accountInfo.bank_name).substring(0, 15) + ' - Termina en ' + (accountInfo.acc_number).substring(15, 20)}</span>
        </div>
      ...
      <>
        ...
        <p>Hemos recibido toda la información de esta solicitud. Se te ha enviado un correo con todos los datos. Puedes tambien revisar todo el detalle de este y otros pagos en tu <Link to="/dashboard">actividad</Link>.</p>
      </>
    }
    </div>
  )
